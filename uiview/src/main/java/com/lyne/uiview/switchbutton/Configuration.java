...
public class Configuration implements Cloneable {
	...
	static class Default {
		...
		static int DEFAULT_ON_COLOR = Color.parseColor("#44DB5E");
		static int DEFAULT_DISABLE_COLOR = Color.parseColor("#4C44DB5E");
	 ...
	 */
	private Drawable mOnDrawable = null, mOffDrawable = null, mDisableDrawable = null;
	/**
	 * drawable of thumb
	 */
	private Drawable mThumbDrawable = null;

	private int mOnColor = Default.DEFAULT_ON_COLOR, mOffColor = Default.DEFAULT_OFF_COLOR, mThumbColor = Default.DEFAULT_THUMB_COLOR, mDisableColor = Default.DEFAULT_DISABLE_COLOR;
	...
	void setDisableDrawable(Drawable disableDrawable) {
		if (disableDrawable == null) {
			throw new IllegalArgumentException("disable drawable can not be null");
		}
	...
	public Drawable getDisableDrawableWithFix() {
		if (mDisableDrawable != null) {
			return mDisableDrawable;
		} else {
			return getDrawableFromColor(mDisableColor);
		}
	}
