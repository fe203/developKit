package com.lyne.uiview.switchbutton;
...
public class SwitchButton extends CompoundButton {
    ...
    private OnDisableTipListener onDisableTipListener;
    ...
    public void setOnDisableTipListener(OnDisableTipListener onDisableTipListener) {
        this.onDisableTipListener = onDisableTipListener;
    }
    ...
    private void fetchDrawableFromAttr(TypedArray ta) {
        ...
        mConf.setDisableDrawable(fetchDrawable(ta, R.styleable.SwitchButton_thumbDrawable,
                R.styleable.SwitchButton_thumbColor, Configuration.Default.DEFAULT_DISABLE_COLOR));
    }
    ...
    public void setConfiguration(Configuration conf) {
        ...
        mConf.setDisableDrawable(conf.getDisableDrawableWithFix());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mEnable){
            ...
            mConf.getDisableDrawable().setAlpha(calcAlpha());
            mConf.getDisableDrawable().draw(canvas);
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (mEnable){
                ...
                if (onDisableTipListener != null){
                    onDisableTipListener.onTip();
                }
                return false;
            }
    ...
    public interface OnDisableTipListener{
        void onTip();
    }
}
